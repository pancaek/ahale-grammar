...
\begin{example}
  \preamble ˈti.ʔi.ka ˈki.ta.la
    \pronunciation ti'ika kitala
    \gloss
      ti'ika & branch \\
...
This particular phrase necessitates the use of the associative particle \nativetext{'e}, which achieves the desired relationship. This will be further detailed in \ref{ch:morpho-adj}, though the correct formation is illustrated by the following:
...
\aside{While it is expected that a la-form refer to one's birthplace, this is not univerally true in colloquial usage.}
\aside {In the case of young children who grow up in a different place than they were born, la-forms may shift to the more formative, newer location.}
