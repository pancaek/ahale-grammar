...
Lexical dual nouns and collective nouns may be modified by \DST\ to refer to multiple \detail{complete} sets.
...
An exception to the verbal restrictions surrounding generalization occurs when expressing opinions about the \detail{attributes} of the an object.%
\sidenote{The attribute must be \rom{ali'a nu} \trans{an inherent quality} of the object being described, and must appear alongside the associative particle, \rom{'e}.}%
\sidenote{Qualities which can be described this way are idealized or culturally significant.
...
The plural reading of \morphtext{me} occurs with personal pronouns, foreign loans that are not lexical duals, or loans which have not been sufficiently nativized, as with \labelcref{ex:nativized-loans}.
