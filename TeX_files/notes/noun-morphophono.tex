...
The ergative case is marked through reduplication of the initial mora\sidenote{A moraic analysis of this process is preferred to a syllabic one, as it better accounts for the vowel coalescence present in most dialects.}, with the absolutive case left unmarked.
...
\begin{columns}[cols.markup=\mutations]
  \cols a'u & \highlight{a'a}u & \FIRST\SG
...
\begin{columns}[cols.markup=\mutations]
  \cols i'a & \highlight{i'iw}a & \SECOND\SG
...
However, the morpheme boundary between \morphtext{me} and the stem blocks the typical vowel coalescence from occuring.\sidenote{To reflect this, these examples are syllabified as \phomtext{mə.u.pə} and \phomtext{u.mə.u.pə} respectively, rather than \phomtext{məu.pə} and \phomtext{u.məu.pə}.}
...
As such, the diphthongs are not further reduced\sidenote{\phomtext{əu} and \phomtext{əi} remain \phontext{o} and \phontext{e} respectively in dialects where this coalescence is standard.} or subjected to hiatus.
