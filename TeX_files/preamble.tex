...
%! glossaries must be before baabbrevs
\usepackage[nogroupskip,nonumberlist]{glossaries}
\usepackage{glossary-mcols}

\usepackage[nostandards,mcolblock]{baabbrevs}
...
\DeclareCaptionJustification{smartragged}{\ifoddpage\raggedright \else \raggedleft\fi}

\newcommand{\aside}[1]{
\marginpar{\strictpagecheck\checkoddpage \ifoddpage\raggedright \else \raggedleft\fi \captionsetup{justification=smartragged, font=footnotesize} \footnotesize #1}
}
