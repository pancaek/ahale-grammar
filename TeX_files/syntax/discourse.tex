...
\langword{Naʔu} is almost never used in colloquial, and even most formal speech. When discussing opinions, \langword{lelewine} and \langword{mili} are used for the most strong feelings. \langword{Naʔu} and \langword{tamuka} are a niche innovation used exclusively in formal logic. They are used when discussing the results of mathematical operations, proofs, and chains of logic, among other things whose truth value is assigned via formal logic.
